...
const CardBack: React.FC = () => {
    return (
        <div className="w-[375px] h-[525px] p-[5px] bg-card-bg font-sans flex flex-col justify-center items-center border-[6px] border-solana-purple rounded-[20px] text-white overflow-hidden">
